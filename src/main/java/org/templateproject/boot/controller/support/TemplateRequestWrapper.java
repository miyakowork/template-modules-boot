...
import me.wuwenbin.lang.common.WebFireWallUtils;
...
/**
 * Created by wuwenbin on 2017/4/4.
 */
public class TemplateRequestWrapper extends HttpServletRequestWrapper {
    ...
    protected String filterParamStrings(String beforeFilter) {
        ...
        if (this.filterXSS)
            afterFilter = WebFireWallUtils.stripSqlXSS(afterFilter);
        if (this.filterSQL)
            afterFilter = WebFireWallUtils.stripSqlInjection(afterFilter);
        return afterFilter;
    }
